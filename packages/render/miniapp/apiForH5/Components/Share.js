                ...
                {this.state.showShareLink ? (
                    <div className='share2019'>
                        <div className='c-popup-content'>
                            <div className='c-share-copytip-content'>
                                <div className='c-share-copytip-text'>长按复制下方链接，去粘贴给好友吧：</div>
                                <div className='c-share-copytip-linkwr'>
                                    <a className='c-share-copytip-link' href={this.props.path} target='_blank'>
                                        {this.props.path}
                                    </a>
                                </div>
                            </div>
                            <div className='c-share-copytip-cancel-btn' onClick={this.handleShareCancel}>
                                取消
                            </div>
                        </div>
                    </div>
                        ...
                        {shareTypes.map((share, index) => {
                            return (
                                <div
                                    ...
                                    key={index}
                                    onClick={this.handleShareClick.bind(this, share.key)}>
                                    <svg width='32' height='32' viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg'>
                                        <defs>
                                            <style />
                                        </defs>
                                        <path d={share.icon.d} fill={share.icon.fill} class='transform-group' />
                                    </svg>
